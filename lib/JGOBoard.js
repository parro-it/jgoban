 ...
 * @retuns {int} Array of opponent stones captured, or -1 if move not allowed (on top of another stone or suicide)
 */
JGOBoard.prototype.play = function(coord, stone) {
    ...
    if (captures.length === 0 && !this.hasLiberties(this.getGroup(coord))) { // suicide
